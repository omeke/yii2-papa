...
use backend\themes\admin\widgets\Alert;
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    ...
                                    <p>
                                        ...
                                        <small><?= Yii::t('admin', 'Member since') ?> <?= Yii::$app->user->identity->created ?></small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p>
                                <?= Yii::t('admin', 'Hello, {name}', ['name' => Yii::$app->user->identity->profile->name]) ?>
                            </p>
                            <a>
